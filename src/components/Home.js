    ...
    <div>
              ...
              <div className="bg-purple-100 rounded-lg p-8 flex items-center justify-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="leading-relaxed text-base">
                    Hair cutting is the art and technique of shaping and styling hair to achieve desired looks and textures.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3">
              <div className="bg-purple-100 rounded-lg p-8 flex items-center justify-center">
                <div className="ml-4">
                  ...
                  <p className="leading-relaxed text-base">
                    Beard shaving involves trimming and shaping facial hair to maintain a desired length and style.
                  </p>
                </div>
                <svg
                  width="200"
                  ...
                  className="w-16 h-16 text-purple-500 ml-4"
                  aria-hidden="true"
                >
                  <path
            ...
            <div className="p-4 md:w-1/3">
              <div className="bg-purple-100 rounded-lg p-8 flex items-center justify-center">
                <svg
                  ...
                  viewBox="0 0 200 200"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-16 h-16 text-purple-500 mr-4"
                  aria-hidden="true"
                >
                  <g fill="none" stroke="currentColor" strokeWidth="5">
                    <rect x="60" y="20" width="80" height="20" fill="currentColor" />
                    <path d="M70 40 L130 40 L140 150 L60 150 Z" fill="none" />
                    <line x1="60" y1="150" x2="70" y2="170" stroke="currentColor" />
                    <line x1="140" y1="150" x2="130" y2="170" stroke="currentColor" />
                    <line x1="70" y1="170" x2="130" y2="170" stroke="currentColor" />
                  </g>
                </svg>
                <div className="ml-4">
                  <h2 className="text-gray-900 text-lg font-medium mb-2">
                  ...
                  <p className="leading-relaxed text-base">
                    Hair coloring is the process of changing the hair's color using various dyes to achieve a desired look or cover gray hairs.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-gray-900 text-white body-font">
        <div className="container mx-auto py-24 text-center">
          ...
          <Link
            to="/booking"
            className="bg-purple-500 hover:bg-purple-600 text-white py-3 px-8 rounded-lg text-lg"
          >
            Book Now
          </Link>
        </div>
