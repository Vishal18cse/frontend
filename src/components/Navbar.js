  ...
  return (
    <header className="bg-gray-800 text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-3 flex-row items-center justify-between">
        ...
        <nav
          className={`md:flex md:items-center md:ml-auto md:mr-auto w-full md:w-auto ${isOpen ? 'block' : 'hidden'}`}
        >
          <Link className="block md:inline-block mt-4 md:mt-0 mr-5 hover:text-violet-400 text-white" to="/" 
          onClick={closeMenu}>
            Home
          </Link>
          <Link className="block md:inline-block mt-4 md:mt-0 mr-5 hover:text-violet-400 text-white" to="/Price" onClick={closeMenu}>
            Price
          </Link>
          <Link className="block md:inline-block mt-4 md:mt-0 mr-5 hover:text-violet-400 text-white" to="/BookingForm" onClick={closeMenu}>
            Book Now
          </Link>
          <Link className="block md:inline-block mt-4 md:mt-0 mr-5 hover:text-violet-400 text-white" to="/Contact" onClick={closeMenu}>
            Contact Us
          </Link>
          <Link className="block md:inline-block mt-4 md:mt-0 mr-5 hover:text-violet-400 text-white" to="/About" onClick={closeMenu}>
            About
          </Link>
          
          <Link className="block md:inline-block mt-4 md:mt-0 mr-5 hover:text-violet-400 text-white" to="/Login" onClick={closeMenu}>
           Admin Login
          </Link>
          <Link className="block md:inline-block mt-4 md:mt-0 mr-5 hover:text-violet-400 text-white" to="/AppointmentList" onClick={closeMenu}>
           AppointmentList
          </Link>
        </nav>
      </div>
